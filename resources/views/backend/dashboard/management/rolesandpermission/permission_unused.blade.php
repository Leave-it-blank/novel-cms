<x-layouts.admin_layout>
    <div class="antialiased sans-serif text-blue-500">
        <style>
            [x-cloak] {
                display: none;
            }
                ...
                <table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
                    ...
                    <template x-for="user in users" :key="user.Id">
                        <tr>
                            ...
                            <td class="border-dashed border-t border-gray-200 updated">
								<span class="text-gray-700 px-6 py-3 flex items-center"
                                      x-text="user.updated"></span>
                            </td>
                            <td class="border-dashed border-t border-gray-200 created">
								<span class="text-gray-700 px-6 py-3 flex items-center"
                                      x-text="user.created"></span>
                            </td>
                        </tr>
                    </template>
                    </tbody>
