        ...
        <div class="grid grid-cols-1 xl:grid-cols-6">
            ...
            <div class="xl:col-span-2 mt-8 xl:mt-20 xl:mr-4 ">
                ...
                <div class="py-2 md:mt-4">
                    <x-dashboard.books.upload :book="$book" :volume="$volume" :chapter="$chapter">
                    </x-dashboard.books.upload>
                </div>
            ...
            <div class="col-span-4 xl:mt-12">
              ...
              @livewire('backend.admin.books.page.comic-data-table' ,['book'=> $book ,'volume'=>$volume ,
                'chapter'=>$chapter ])
