...
<div x-transition:enter="transition duration-300 ease-in-out" x-transition:enter-start="opacity-0"
     ...
     @click="isSettingsPanelOpen = false" class="fixed inset-0 z-10 bg-blue-800"
     style="opacity: 0.5; display: none;" aria-hidden="true"></div>
<!-- Panel -->
<section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
         ...
         aria-labelledby="settinsPanelLabel" style="display: none;">
    ...
    <div class="flex flex-col h-screen">
        <!-- Panel header -->
        <div
            class="flex flex-col flex-shrink-0 justify-center items-center py-8 px-4 space-y-4 border-b dark:border-blue-700">
        ...
        <!-- Content -->
        <div class="overflow-hidden flex-1 hover:overflow-y-auto">
            <!-- Theme -->
            <div class="p-4 space-y-4 md:p-8">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <button @click="setLightTheme"
                            class="flex justify-center items-center py-2 px-4 space-x-4 text-gray-500 rounded-md border transition-colors hover:text-gray-900 hover:border-gray-900 dark:border-blue-700 dark:hover:text-blue-100 dark:hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-400 dark:focus:ring-indigo-700 dark:text-blue-500"
                    ...
                    <button @click="setDarkTheme"
                            class="flex justify-center items-center py-2 px-4 space-x-4 text-gray-900 rounded-md border border-gray-900 transition-colors hover:text-gray-900 hover:border-gray-900 dark:border-blue-700 dark:hover:text-indigo-100 dark:hover:border-blue-500 focus:outline-none focus:ring focus:ring-blue-400 dark:focus:ring-blue-700 dark:border-blue-500 dark:text-blue-100"
                            :class="{ 'border-gray-900 text-gray-900 dark:border-blue-500 dark:text-blue-100': isDark, 'text-gray-500 dark:text-blue-500': !isDark }">
                    <span>
                      <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                           stroke="currentColor">
